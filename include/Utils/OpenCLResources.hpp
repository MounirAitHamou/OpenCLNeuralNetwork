...
const cl_bool NON_BLOCKING = CL_FALSE;
...
namespace Utils
{
    ...
    public:
        ...
        static OpenCLResources createOpenCLResources(const std::string &p_kernelsPath = KERNELS_DIR, size_t p_platformIndex = 0, size_t p_deviceIndex = 0, bool p_verbose = false);
