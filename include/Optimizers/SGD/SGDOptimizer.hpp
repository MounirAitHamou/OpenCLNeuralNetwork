...
namespace Optimizers
{
    ...
    private:
        ...
        void saveSGDOptimizer(H5::Group &p_optimizerGroup) const { saveOptimizer(p_optimizerGroup); }
        bool sgdOptimizerEquals(const Optimizer &p_other) const { return optimizerEquals(p_other); }
