...
namespace Layers::Trainable
{
    ...
    public:
        ...
        Utils::Dimensions getWeightsDimensions() const { return Utils::Dimensions({getTotalInputElements(), getTotalOutputElements()}); }
        Utils::Dimensions getBiasesDimensions() const { return Utils::Dimensions({getTotalOutputElements()}); }
        ...
        Visualization::LayerVisualization buildVisualization(const cl::CommandQueue &p_queue, const Visualization::VisualizationOptions &p_options, size_t p_batchSize) const final override { return buildDenseLayerVisualization(p_queue, p_options, p_batchSize); }
    ...
    private:
        ...
        Visualization::LayerVisualization buildDenseLayerVisualization(const cl::CommandQueue &p_queue, const Visualization::VisualizationOptions &p_options, size_t p_batchSize) const
        {
