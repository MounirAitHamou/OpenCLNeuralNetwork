...
namespace Layers::Trainable
{
    ...
    public:
        ...
        {
            return Utils::readCLBuffer(p_queue, m_weights, NO_OFFSET, getWeightsSize());
        }

        std::vector<float> getBiasesCPU(const cl::CommandQueue &p_queue) const
        {
            return Utils::readCLBuffer(p_queue, m_biases, NO_OFFSET, getBiasesSize());
        }
        ...
        virtual Utils::Dimensions getWeightsDimensions() const = 0;
        virtual Utils::Dimensions getBiasesDimensions() const = 0;
        ...
        virtual Visualization::LayerVisualization buildVisualization(
            ...
            size_t p_batchSize) const override { return buildTrainableLayerVisualization(p_queue, p_options, p_batchSize); }
    ...
    protected:
        ...
        const cl::Buffer *getBuffer(Visualization::BufferType p_type) const override
        {
            ...
            case Visualization::BufferType::WeightGradients:
                return &m_weightsGradients;
            case Visualization::BufferType::BiasGradients:
                return &m_biasesGradients;
            default:
        ...
        Utils::Dimensions getBufferDimensions(Visualization::BufferType p_type, size_t p_sampleCount) const override
        {
            ...
            {
            case Visualization::BufferType::Weights:
                return getWeightsDimensions();
            case Visualization::BufferType::Biases:
                return getBiasesDimensions();
            case Visualization::BufferType::WeightGradients:
                return getWeightsDimensions();
            case Visualization::BufferType::BiasGradients:
                return getBiasesDimensions();
        ...
        Visualization::LayerVisualization buildTrainableLayerVisualization(const cl::CommandQueue &p_queue, const Visualization::VisualizationOptions &p_options, size_t p_batchSize) const
        {
            Visualization::LayerVisualization visualization = buildLayerVisualization(p_queue, p_options, p_batchSize);
            visualization.m_metadata.push_back("Input Dimensions: " + m_inputDimensions.toString());
            visualization.m_metadata.push_back("Weights Size: " + getWeightsDimensions().toString());
            visualization.m_metadata.push_back("Biases Size: " + getBiasesDimensions().toString());
