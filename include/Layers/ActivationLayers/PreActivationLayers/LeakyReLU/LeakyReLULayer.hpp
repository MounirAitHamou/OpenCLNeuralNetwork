...
namespace Layers::Activation
{
    ...
    public:
        ...
        void save(const cl::CommandQueue &, H5::Group &p_layerGroup) const final override { saveLeakyReLULayer(p_layerGroup); }
        bool equals(const cl::CommandQueue &, const Layer &p_other) const final override { return leakyReLULayerEquals(p_other); }
    ...
    private:
        ...
        void saveLeakyReLULayer(H5::Group &p_layerGroup) const
        {
            saveLayer(p_layerGroup);
            Utils::writeValueToHDF5<float>(p_layerGroup, "alpha", m_alpha);
        }

        bool leakyReLULayerEquals(const Layer &p_other) const
        {
