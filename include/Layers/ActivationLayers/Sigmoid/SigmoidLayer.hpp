...
namespace Layers::Activation
{
    ...
    private:
        ...
        void saveSigmoidLayer(H5::Group &p_layerGroup) const { saveLayer(p_layerGroup); }
        bool sigmoidLayerEquals(const SigmoidLayer &p_other) const { return layerEquals(p_other); }
