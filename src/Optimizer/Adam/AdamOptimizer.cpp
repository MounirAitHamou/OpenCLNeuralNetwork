...
AdamOptimizer::AdamOptimizer(const OpenCLSetup& ocl_setup, const H5::Group& optimizer_group)
    :Optimizer(ocl_setup){
...
void AdamOptimizer::updateParameters(std::string param_id,
...
void AdamOptimizer::saveOptimizer(H5::Group& optimizer_group,
