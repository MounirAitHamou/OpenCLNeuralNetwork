    ...
    std::unique_ptr<Optimizer> loadOptimizer(std::shared_ptr<Utils::SharedResources> p_oclResources,
        ...
        switch (optimizerTypeFromUint(optimizerType)) {
            case OptimizerType::SGD:
                return std::make_unique<SGDOptimizer>(p_oclResources, p_optimizerGroup);
            case OptimizerType::Adam:
                return std::make_unique<AdamOptimizer>(p_oclResources, p_optimizerGroup);
            case OptimizerType::AdamW:
                return std::make_unique<AdamWOptimizer>(p_oclResources, p_optimizerGroup);
            default:
